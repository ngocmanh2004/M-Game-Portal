...
export const SupportModal: React.FC<SupportModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        { title: "Game Mới", desc: "Cập nhật trò chơi lạ", icon: "M11 4a2 2 0 114 0v1a2 2 0 01-2 2H3a2 2 0 01-2-2V4a2 2 0 114 0v1a2 2 0 01-2 2h8a2 2 0 01-2-2V4z M7 15l-3 3m0 0l3 3-3-3h12a2 2 0 002-2v-3" },
                            ...
                            <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/10 rounded-[3rem] p-8 lg:p-10 text-center relative overflow-hidden group shadow-2xl">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div
                                        className="bg-white/5 rounded-[2.5rem] w-56 h-56 lg:w-64 lg:h-64 mx-auto mb-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] group-hover:scale-105 transition-transform duration-700 overflow-hidden ring-8 ring-white/5 relative cursor-pointer"
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-2 right-2 p-1.5 rounded-lg bg-black/40 text-white backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            {isZoomed && (
                <div
                    className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/95 backdrop-blur-xl animate-in fade-in duration-300"
                    onClick={() => setIsZoomed(false)}
                >
                    <div
                        className="relative max-w-2xl w-full aspect-square animate-in zoom-in-95 duration-300"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <button
                            onClick={() => setIsZoomed(false)}
                            className="absolute top-8 right-1 p-3 rounded-2xl bg-white/10 text-white hover:bg-white/20 transition-all border border-white/10 z-[10001] shadow-2xl backdrop-blur-md"
                        >
                        ...
                        <div className="w-full h-full rounded-[3rem] overflow-hidden shadow-2xl border border-white/10">
                            <img
                                src="/assets/image/QR/qr-donate.png"
                                alt="Vietcombank QR Large"
                                className="w-full h-full object-contain"
                            />
                            <div className="absolute bottom-16 left-0 right-0 text-center px-4">
                                 <span className="inline-block px-6 py-2 rounded-full bg-black/60 backdrop-blur-md border border-white/10 shadow-2xl">
                                    <p className="text-white font-black uppercase text-[10px] sm:text-xs tracking-[0.2em]">Cảm ơn bạn đã ủng hộ ! ❤️</p>
                                 </span>
                            </div>
                        </div>
                    </div>
